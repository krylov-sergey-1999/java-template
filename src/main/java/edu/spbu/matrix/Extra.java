...
public class Extra {
    ...
    public static void convCRS(SparseMatrix x){
        ...
        int n = arr.length;
        int m = arr[0].length;
        ArrayList<Integer> args = new ArrayList<Integer>(); // значения
        ArrayList<Integer> LI = new ArrayList<Integer>(); // строки
        ArrayList<Integer> LJ = new ArrayList<Integer>(); // столбцы
        int k = 0;
        LI.add(k);
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < m; j++) {
    ...
    public static void convCCS(SparseMatrix x) {
        int arr[][] = x.getArr();
        int n = arr.length; // строки
        int m = arr[0].length; // столбцы
        ArrayList<Integer> args = new ArrayList<Integer>(); // значения
        ArrayList<Integer> LI = new ArrayList<Integer>();  // строки
        ArrayList<Integer> LJ = new ArrayList<Integer>();  // столбцы
        int k = 0;
    ...
    public static void printInfoSparceMatrix(SparseMatrix x) {
        System.out.println("Матрица размером: " + x.getLine() + " * " + x.getColumn());
        System.out.println("CSR:");
        System.out.println("Аргументы: " + x.getArgs_one());
        System.out.println("Столбцы: " + x.getOne_column());
        System.out.println("Строки: " + x.getOne_line());
        System.out.println("CSC:");
        System.out.println("Аргументы: " + x.getArgs_two());
